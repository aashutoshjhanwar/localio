...
export function ListingDetailScreen() {
  ...
  async function shareListing() {
    try {
      ...
      // Public URL — WhatsApp/iMessage/Twitter unfurl this and render the OG card
      // (price + photo + trust badge) generated by /api/listings/:id/og.svg.
      const { PUBLIC_URL } = await import('../config');
      const url = `${PUBLIC_URL}/l/${listing.id}`;
      await Share.share({
